                            ...
                            NSCoding>
{
    ...
    BOOL       phoneStar;   //是否接听电话
    BOOL       locationStar;//是否定位
    BOOL       listenStar;  //是否试听
    
    NSString   *timePeriod; //时间段
...
@property (nonatomic, assign) BOOL         phoneStar;
@property (nonatomic, assign) BOOL         locationStar;
@property (nonatomic, assign) BOOL         listenStar;
